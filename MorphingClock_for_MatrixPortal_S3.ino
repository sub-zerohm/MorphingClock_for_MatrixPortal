...
Adafruit_Protomatter matrix(
  ...
  true);                     // Turn off double buffering because morph clock draws AND erases pixels to create animation.
...
void runMenu()
{
  ...
  {
    bool upButtonPressed = digitalRead(NEXT_BUTTON)==0;
    bool downButtonPressed = digitalRead(BACK_BUTTON)==0;
